...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      xplizit = described_class.new('redbull', 16)
      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(xplizit.type).to be('redbull')
      end

      # remove the 'x' before running this test
      it 'has 16 ounces' do
        expect(xplizit.ounces).to be(16)
      end
    end
  end
  ...
  describe '#full?' do
    ...
    context 'when drink has less than 16 ounces' do
      ...
      xplizit = described_class.new('redbull', 11)
      # remove the 'x' before running this test
      it 'is not full' do
        expect(xplizit).not_to be_full
      end
    end
  end
end
